    ...
    <section id="experience" className="py-20 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="text-muted-foreground mb-10">{t("experience.subtitle")}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4">
          {companies.map((c, i) => (
            <motion.a
              ...
              className="bg-foreground/90 border border-border rounded-lg p-3 flex items-center justify-center hover:border-primary/50 hover:scale-105 transition-all aspect-square"
              title={c.name}
            >
